...
This website uses **Umami Cloud** for anonymous usage statistics.
*   **No Cookies:** Umami does not set any cookies on your device.
*   **No Personal Data:** IP addresses are anonymized before being stored. No personal information (PII) is collected.
...
*   **Legal Basis:** Legitimate Interest (GDPR Art. 6(1)(f)) for ensuring network and information security.
